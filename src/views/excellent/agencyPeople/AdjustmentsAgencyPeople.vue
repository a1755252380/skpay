    ...
    <el-dialog :title="'金额调整'" :visible.sync="showData" width="400px" append-to-body :before-close="() => {
        ...
        <el-form ref="form" :model="form" label-width="80px" class="Breakdown-el-form">
            ...
            <el-form-item label="登录名称">
                <el-input v-model="form.logName" placeholder="请输入登录名称" disabled />
            </el-form-item>
            <el-form-item label="调整金额">
                <el-input-number v-model="num" placeholder="请输入金额" class="w100_input" />
            </el-form-item>
...
export default {
    ...
    methods: {
        submitForm() {
            this.form.fundAdjustment = this.num
