  ...
  methods: {
    ...
    readyselectable(row, index) {
      ...
      if (row.parentId == 0) {
        ...
        if (this.treeTableDataClone[parentIndex].payout_settle_status != 0) {
          return false;
        }
        //所有金额大于0
        const allZero = this.treeTableDataClone[parentIndex].children.every((selectStatusItem) => {
