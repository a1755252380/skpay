    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="90px">
      <el-form-item label="商户号 " prop="mchNum">
        <MchNumSelect v-model="queryParams.mchNum" @change="handleQuery" @clear="() => {
          this.queryParams.mchNum = null; this.queryParams.SearchIndex = -1
        }"></MchNumSelect>
      </el-form-item>
...
export default {
  ...
  computed: {
    ...
    paginatedItems() {
      ...
      if (this.queryParams.mchNum) {
        return this.mchSettlementList.slice(this.queryParams.SearchIndex, this.queryParams.SearchIndex + 1);
  ...
  methods: {
    ...
    handleQuery() {
      ...
      this.queryParams.SearchIndex = this.mchSettlementList.findIndex(res => {
